...
def favorites_results():
    ...
    user_fave_animal = request.args.get('animal')
    user_fave_color = request.args.get('color')
    user_fave_city = request.args.get('city')
    return f"Wow, I didn't know {user_fave_color} {user_fave_animal}s lived in {user_fave_city}!"
...
def message_results():
    ...
    return f"<p>Here's your secret message</p> <br> <p>{sort_letters(secret_message)}</p>"
